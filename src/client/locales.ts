...
export const zh = {
  ...
  failed: '提交失败',
  newSession: '新建会话',
  newSessionTooltip: '在当前工作区新建一个会话，agent 预设与权限沿用部署默认设置',
} as const
...
export const en = {
  ...
  newSessionTooltip: 'Start a new session in this workspace with the deployment’s default agent preset and permissions',
} as const
